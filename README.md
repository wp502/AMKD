# Adaptive Multimodal Distillation via Coordinating Heterogeneous Supervision
...
├── distillers/               # Distillation methods (MSD, DSMD, AMD, etc.)
...
Our proposed method: **AMD (Adaptive Knowledge Distillation)**
